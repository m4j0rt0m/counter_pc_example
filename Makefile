...
# Description:  Counter PC Project Makefile
#################################################################
...
.PHONY: all lint sim clean project compile-flow create-project create-project-tcl del-bak create-sdc
